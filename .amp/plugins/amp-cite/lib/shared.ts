...
export const USER_AGENT = "amp-cite/0.1 (+https://github.com/fbraza/amp-cite)"
...
export function stringParam(input: Record<string, unknown>, key: string, required = false): string | undefined {
...
export function booleanParam(input: Record<string, unknown>, key: string): boolean | undefined {
	const value = input[key]
...
export function stringArrayParam(input: Record<string, unknown>, key: string): string[] | undefined {
	const value = input[key]
	if (value === undefined) return undefined
...
export function integerParam(input: Record<string, unknown>, key: string, defaultValue: number, min: number, max: number): number {
	const value = input[key]
